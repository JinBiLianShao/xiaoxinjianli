...
<div class="form" style="width: 800px; height: 500px; margin: 50px auto">
    <!-- Form itself -->
    <form name="sentMessage" class="well" id="contactForm" novalidate action="<?php echo ($name); ?>/home/index/password" method="post">
        <div class="control-group">
            <div class="form-group">
                <input type="text" class="form-control" placeholder="UerName" id="uername" required
                       data-validation-required-message="Please enter your name"  name="uername"/>
        ...
        <div class="form-group">
            <div class="controls">
                <input type="text" class="form-control" placeholder="Name" id="name" required
                       data-validation-required-message="Please enter your email" name="name" />
            </div>
        </div>
        <div class="form-group">
            <input type="email" class="form-control" placeholder="Email" id="email" required
                   data-validation-required-message="Please enter your name"  name="email"/>
            <p class="help-block"></p>

        </div>

        <div id="success"> </div> <!-- For success/fail messages -->
        <button type="submit" class="btn btn-primary pull-right">重设密码</button><br />
    </form>
</div>
