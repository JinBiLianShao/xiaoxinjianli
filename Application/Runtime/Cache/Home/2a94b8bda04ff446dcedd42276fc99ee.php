...
<html lang="en">
		...
		<header id="header">
			<div class="container">
				...
				<nav id="nav-menu-container">
					<ul class="nav-menu">
						<li class="menu-active"><a href="<?php echo ($name); ?>/home/index/index">首页</a></li>
  ...
  ============================-->
		<section id="intro">
			...
			<div class="intro-content">
				<h2><span>免费简历</span><br>请登陆后免费使用哦！没有账号的宝贝们请<a href="<?php echo ($name); ?>/home/index/register">注册</a>哈！</h2>
				<div>
					<a href="<?php echo ($name); ?>/home/index/login" class="btn-get-started scrollto">登陆</a>
				</div>
			</div>
			<div class="item" style="background-image: url('<?php echo ($name); ?>/public/img/intro-carousel/1.jpg');"></div>
		</section><!-- #intro -->
			...
			<section id="about" class="wow fadeInUp">
				<div class="container">
					<div class="section-header">
						<h2>如何写好一份简历</h2>
						<p>六月份，又到毕业季了，又将有一大批应届毕业生迈出校门，步入职场。
						那么对于很多没有工作经验的应届毕业生来说，应该不知道如何去写好一份简历吧!
						简历对于一个求职者来说就是一个门面，是吸引企业关注自己的第一关，也是求职的第一关，
						那么我们怎样去写出一份好的求职简历呢?</p>
					</div>
					<div class="row">
						<div class="col-lg-6 about-img">
							<img src="<?php echo ($name); ?>/public/img/about-img.png" alt="">
						</div>

						<div class="col-lg-6 content">
							<h3>第一部分：基本信息</h3>
							<p style="font-size: 12px;">
							这一点最重要的就是真实，可靠。我们只有把自己的一些基础信息认真且全面的填写上去，
							能让企业了解到自己和联系到自己就行了。
							最后再把自己美丽或者帅气的照片贴上去就可以了。</p>
							<h3>第二部分：工作经验</h3>
							<p style="font-size: 12px;">
							这估计是很多同学都不知道怎么写的一个部分吧!其实这里我们可以把自己在校期间组织过的一些社团活动写上，
							也可以把自己参加过的兼职或者暑假工时的一些工作经验写上去。
							在写工作经验时一定要有针对性，如果写一些与应聘单位无关紧要的工作经验，那写上去也是毫无意义的。</p>
							<h3>第三部分：荣誉证书</h3>
							<p style="font-size: 12px;">现在企业在招人的时候大多数会考虑选择一些综合实力强的人才，
							所以我们可以把自己在校期间所得过的一些荣誉奖项和技能证书也写上去，
							让招聘单位对你有进一步的了解，这将会大大提高你应聘成功的几率</p>
						</div>
					</div>
    ...
    ============================-->
			<section id="services">
				<div class="container">
					<div class="section-header">
						<h2>网站特色</h2>
						<p>我一个人开发精力有限，目前能够展示的不多。相信不久的未来，会有更多的功能提供给大家使用。</p>
					</div>
					...
					<div class="row">
						...
						<div class="col-lg-4">
							<div class="box wow fadeInLeft">
								<div class="icon svgImg"><img src="<?php echo ($name); ?>/public/img/undraw_maker_launch_crhe.svg" alt=""></div>
								<h4 class="title"><a href="">简历快速生成</a></h4>
								<p class="description">用户通过表格的形式快速，定向完成一份简历，并生成网页版个人简历。</p>
							</div>
						</div>

						<div class="col-lg-4">
							<div class="box wow fadeInRight">
								<div class="icon svgImg"><img src="<?php echo ($name); ?>/public/img/undraw_mobile_marketing_iqbr.svg" alt=""></div>
								<h4 class="title"><a href="">手机端网页兼容</a></h4>
								<p class="description">生成网页版简历将进行手机端兼容设置，电脑，手机都可以很清晰的让企业了解你。</p>
							</div>
						</div>

						<div class="col-lg-4">
							<div class="box wow fadeInLeft" data-wow-delay="0.2s">
								<div class="icon svgImg"><img src="<?php echo ($name); ?>/public/img/undraw_scrum_board_cesn.svg" alt=""></div>
								<h4 class="title"><a href="">转PDF格式</a></h4>
								<p class="description">支持将网页版简历转pdf格式下载到您的手机或者电脑，让投简历更加便捷。</p>
							</div>
						</div>
    ...
    ============================-->
			<section id="testimonials" class="wow fadeInUp">
				<div class="container">
					<div class="section-header">
						<h2>留言板</h2>
						<p>欢迎大家留言，指出不足和需要改进的地方，相信我们会越做越好！！</p>
					</div>
					<div class="owl-carousel testimonials-carousel">

						<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="testimonial-item">
							<p><?php echo ($vo["text"]); ?>

							</p>
							<h3><?php echo ($vo["name"]); ?></h3>
							<h4><?php echo ($vo["email"]); ?></h4>
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-lg-3 cta-btn-container text-center">
							<a class="cta-btn align-middle" href="javascript:;" onClick="myselfinfo()">加入我们</a>
						</div>
					</div>
  ...
  ============================-->
		...
		<script type="text/javascript" src="<?php echo ($name); ?>/public/admin/lib/jquery.contextmenu/jquery.contextmenu.r2.js"></script>
		<script type="text/javascript" src="<?php echo ($name); ?>/public/admin/lib/layer/2.4/layer.js"></script>
		<script type="text/javascript">
			...
			function myselfinfo(){
				layer.open({
					...
					shade: 0.4,
					title: '加入我们',
					content: '<img width="400px" height="400px" src="<?php echo ($name); ?>/public/img/QQ.jpg" alt="">'
