...
<section id="innerBanner">
    <div class="inner-content">
        <h2><span>注册</span><br>欢迎注册小鑫免费简历</h2>
        <div>
        </div>
    </div>
</section><!-- #Page Banner -->
...
form表单
=========-->
<form method="post" action="<?php echo ($name); ?>/home/index/register">
    <div class="form-group">
        <label for="uername-login">用户名<?php echo ($uername); ?></label>
        <input id="uername-login" type="text" class="form-control" name="uername" style="ime-mode:disabled">
    </div>
    <div class="form-group">
        <label for="name-login">姓名<?php echo ($nane); ?></label>
        <input id="name-login" type="text" class="form-control" name="name">
    </div>
    <div class="form-group">
        <label for="email-login">邮箱<?php echo ($email); ?></label>
        <input id="email-login" type="email" class="form-control" name="email">
    </div>
    <div class="form-group">
        <label for="password-login">密码<?php echo ($password); ?></label>
        <input id="password-login" type="password" class="form-control" name="password">
    </div>
    <div class="text-center">
        <div class="submit" >
            <input type="submit" onclick="myFunction()" value="注册"  style=" border: none">
            <h4><a href="<?php echo ($name); ?>/home/index/login">已注册去登陆！</a></h4>
            <div class="clear">  </div>
        </div>
    </div>
</form>
